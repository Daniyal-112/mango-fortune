...
# === Load Models ===
try:
    yolo_model = YOLO("C:/Users/Daniyal Rehman/OneDrive/Desktop/Finalfyp Copy/runs/detect/mango_vs_nonmango/weights/best.pt")
    cnn_model = load_model("C:/Users/Daniyal Rehman/OneDrive/Desktop/Finalfyp Copy/best_mango_disease_model.keras")
    label_map = joblib.load("C:/Users/Daniyal Rehman/OneDrive/Desktop/Finalfyp Copy/label_encoder.pkl")
...
#                 f"At least 3 mango images are required. Invalid images: {', '.join(invalid_images)} are either not mangoes or not properly captured."
#             )
#             logger.info(error_message)
#             return {
#                 "status": "error",
